...
export interface MoltbotEnv {
  ...
  CONTROL_UI_TOKEN_ONLY?: string; // Set to 'true' to skip Control UI pairing (token-only)
  ...
  ACCESS_BYPASS_HOSTS?: string; // Comma-separated hostnames that skip CF Access checks
