...
RUN apt-get update && apt-get install -y xz-utils ca-certificates rsync bzip2 \
...
# Copy startup script
# Build cache bust: 2026-01-30-v31-sherpa-onnx-tts-download
ARG CACHE_BUST=2026-01-30-v31-sherpa-onnx-tts-download
